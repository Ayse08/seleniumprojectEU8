...
public class T1_StaleElementRefEx {
    public static void main(String[] args) throws InterruptedException {
        ...
        try{
            ...
            System.out.println("deletedButton.isDisplayed() = false");
        }

        //USE XPATH LOCATOR FOR ALL WEBELEMENT LOCATORS
        //
// When we click on delete button, it completely delete the code on the inspection page, so it gives
// error : "staleElementReferenceException" ----> we need to use try/catch block
